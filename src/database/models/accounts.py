...
from src.database import accounts as validators
from src.security import hash_password, verify_password
from src.security import generate_secure_token
...
class User(Base):
    ...
    password_reset_token: Mapped[Optional["PasswordResetToken"]] = (
        relationship(
            "PasswordResetToken",
            back_populates="user",
...
class RefreshToken(TokenBase):
    ...
    def create(
        ...
        This method simplifies the creation of a
        new refresh token by calculating the expiration date
        based on the provided number of valid days and setting
